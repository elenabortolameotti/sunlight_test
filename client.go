// Package sunlight implements a general-purpose append-only log
// based on the Static Certificate Transparency API design.
//
// This is a simplified version for general-purpose use.
package sunlight
