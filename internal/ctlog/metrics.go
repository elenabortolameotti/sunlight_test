...
type metrics struct {
	...
	SeqNamesTileSize     prometheus.Summary
	SeqNamesTileGzipSize prometheus.Summary
...
func initMetrics() metrics {
	return metrics{
		...
		SeqNamesTileSize: prometheus.NewSummary(
			prometheus.SummaryOpts{
				Name:       "sequencing_names_tiles_bytes",
				Help:       "Uncompressed size of uploaded names tiles, including partials.",
				Objectives: map[float64]float64{0.5: 0.05, 0.9: 0.01, 0.99: 0.001},
				MaxAge:     1 * time.Minute,
				AgeBuckets: 6,
			},
		),
		SeqNamesTileGzipSize: prometheus.NewSummary(
			prometheus.SummaryOpts{
				Name:       "sequencing_names_tiles_gzip_bytes",
				Help:       "Compressed size of uploaded names tiles, including partials.",
				Objectives: map[float64]float64{0.5: 0.05, 0.9: 0.01, 0.99: 0.001},
				MaxAge:     1 * time.Minute,
				AgeBuckets: 6,
			},
